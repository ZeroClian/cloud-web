      ...
      <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
          ...
          <li class="">
            ...
            <ul class="submenu">
              <li class="" id="finance-stock-sidebar">
                <router-link to="/finance/stock">
              ...
              <li class="" id="finance-fund-sidebar">
                <router-link to="/finance/fund">
                  <i class="menu-icon fa fa-caret-right"></i>
                  基金
                </router-link>
          ...
          <li class="">
            ...
            <ul class="submenu">
              ...
              <li class="" id="sys-setting-sidebar">
                <router-link to="/sys/setting">
                  <i class="menu-icon fa fa-caret-right"></i>
                  权限管理
                </router-link>
        ...
        <div class="footer-inner">
          <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Cloud</span>
							Hub &copy; 2022-2099
						</span>
          </div>
        </div>
